...
namespace Finbourne.Notifications.Sdk.Extensions.IntegrationTests
{
    ...
    public class ApiExceptionExtensionsTest
    {
        ...
        private CreateNotification _emailNotification;

        [OneTimeSetUp]
        public void SetUp()
        {
            _factory = IntegrationTestApiFactoryBuilder.CreateApiFactory("secrets.json");
            _emailNotification = new CreateNotification(
                ...
                new
                {
                    ...
                    HtmlBody = "htmlBody",
                    EmailAddressTo = new List<string> { "to-unknown@unkown.com" },
                    EmailAddressCc = new List<string>(),
        ...
        {
            var e = Assert.Throws<ApiException>(() =>
                _factory.Api<NotificationsApi>().CreateNotification("no-scope", "no-code", _emailNotification));
        ...
        {
            var e = Assert.Throws<ApiException>(() =>
                _factory.Api<NotificationsApi>().CreateNotification("@£$@£%", "#####", _emailNotification));
        ...
        public void ApiException_Converts_To_ValidationProblemDetails_MaxLength()
        {
            ...
            var e = Assert.Throws<ApiException>(() => 
                _factory.Api<NotificationsApi>().CreateNotification(testScope, testCode, _emailNotification));
